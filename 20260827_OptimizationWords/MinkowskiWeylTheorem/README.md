...
![Variational-Analysis-polyhedral](Variational-Analysis-polyhedral.png)

(次に、以下がconの定義。凸包。)

![Variational-Analysis-con](Variational-Analysis-con.png)

(次に、以下がposの定義。正錐包。)

![Variational-Analysis-pos](Variational-Analysis-pos.png)

(以上より、主張が理解できる。それはそうという感じがしてくる。)

![Variational-Analysis](Variational-Analysis.png)
