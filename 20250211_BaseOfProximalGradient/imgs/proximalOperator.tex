...
\begin{tikzpicture}
  ...
  \foreach \v/\c in {-2/cA,-1/cB,0/cC,1/cD,2/cE} {
      ...
      \ifnum \v=-1
        \draw[\c, domain=-3:0, smooth, variable=\x, dashed, very thick] plot ({\x}, {-\x + 1 +0.5*(\x-\v)^2});
        \draw[\c, domain=0:1.82, smooth, variable=\x, dashed, very thick] plot ({\x}, {1 + 0.3*\x^2 +0.5*(\x-\v)^2});
      \fi
      \ifnum \v=0
      ...
      \fi
      \ifnum \v=1
        \draw[\c, domain=-1.6:0, smooth, variable=\x, dashed, very thick] plot ({\x}, {-\x + 1 +0.5*(\x-\v)^2});
        \draw[\c, domain=0:2.5, smooth, variable=\x, dashed, very thick] plot ({\x}, {1 + 0.3*\x^2 +0.5*(\x-\v)^2});
        \draw[\c, domain=2.5:3.02, smooth, variable=\x, dashed, very thick] plot ({\x}, {(6 - 2.875) / (4 - 2.5) * (\x - 2.5) + 2.875 +0.5*(\x-\v)^2});
      \fi
      \ifnum \v=2
  ...
  \foreach \v/\c in {-2/cA,-1/cB,0/cC,1/cD,2/cE} {
      ...
      \fi
      \ifnum \v=-1
        \node[star, star point height=0.05cm, star point ratio=2.0, scale=0.4, draw=black, fill=\c] at (0,1.5) {};
      \fi
      \ifnum \v=0
